...
echo
echo -e $red "             The Script By:$cyan ZIHAD HOSSAIN RAFI"
echo
echo
...
echo
echo
echo -e $green "         DEVELOPED BY:$cyan ZIHAD HOSSAIN RAFI"
echo -e $green "         GITHUB:$cyan MR-ZIHAD"
echo -e $green "         YOUTUBE:$cyan TECHNICAL ZIHAD"
echo
echo
echo
echo
